...
4. Edit [src/commonMain/kotlin/main.kt](src/commonMain/kotlin/main.kt):
...
7. Export your presentation web page (if target web):
...
8. Change this README to present your presentation ;)
